...
const q = qp([['zicCode', zip], ['maxYear', yearMax], ['minYear', yearMin], ['maxPrice', priceMax]])
return q ? `${base}?${q}` : base
},
},
{
...
<span style={{ fontSize: 11, fontWeight: 700, color: GOLD }}>🤖 AI MATCHED</span>
