...
const PRODUCTS = [
  {
    id:'1', name:'VictoryRevConnect-1 Logo Tee', category:'Apparel',
    price:34.99, compareAt:null, isNew:true, isLimited:false, revPoints:35,
    description:'Premium 100% cotton tee. Embroidered VictoryRevConnect-1 logo on chest. Available Black & White.',
  ...
  {
    id:'2', name:'VictoryRevConnect-1 Snapback Hat', category:'Headwear',
    price:29.99, compareAt:null, isNew:true, isLimited:false, revPoints:30,
    description:'Structured snapback with flat brim. Embroidered VictoryRevConnect-1 logo. One size fits most.',
    sizes:['One Size'],
  ...
  {
    id:'3', name:'VictoryRevConnect-1 Garage Hoodie', category:'Apparel',
    price:64.99, compareAt:79.99, isNew:false, isLimited:false, revPoints:65,
    description:'Heavyweight 400gsm fleece hoodie. Front pocket, embroidered VictoryRevConnect-1 chest logo. Built for the shop.',
    sizes:['S','M','L','XL','2XL','3XL'],
  ...
  {
    id:'4', name:'VictoryRevConnect-1 Dad Hat', category:'Headwear',
    price:24.99, compareAt:null, isNew:false, isLimited:false, revPoints:25,
    description:'Unstructured canvas dad hat with curved brim. Adjustable strap. Embroidered VictoryRevConnect-1 logo.',
    sizes:['One Size'],
  ...
  {
    id:'5', name:'VictoryRevConnect-1 Legend Box — #/500', category:'Collectibles',
  ...
  {
    id:'6', name:'VictoryRevConnect-1 Tumbler 30oz', category:'Drinkware',
    price:39.99, compareAt:null, isNew:false, isLimited:false, revPoints:40,
    description:'Double-wall insulated tumbler. Keeps drinks cold 24hrs, hot 12hrs. Laser-engraved VictoryRevConnect-1 logo.',
    sizes:['30oz'],
  ...
  {
    id:'7', name:'VictoryRevConnect-1 Keychain', category:'Accessories',
    price:14.99, compareAt:null, isNew:true, isLimited:false, revPoints:15,
    description:'Heavy-duty metal keychain with enamel VictoryRevConnect-1 logo. Double-ring construction with carbon fiber texture.',
    sizes:['One Size'],
  ...
  {
    id:'8', name:'VictoryRevConnect-1 Phone Case', category:'Accessories',
    price:24.99, compareAt:null, isNew:false, isLimited:false, revPoints:25,
    description:'Slim hard-shell case with full VictoryRevConnect-1 graphic wrap. Available for iPhone and Samsung models.',
  ...
  {
    id:'9', name:'VictoryRevConnect-1 Sticker Pack (10pc)', category:'Stickers',
    price:12.99, compareAt:null, isNew:false, isLimited:false, revPoints:13,
    description:'10-piece vinyl sticker pack. Logo, wordmarks, racing stripes, and limited holo VictoryRevConnect-1 sticker.',
    sizes:['One Size'],
    colors:['Assorted'],
  ...
  {
    id:'10', name:'VictoryRevConnect-1 Crewneck Sweatshirt', category:'Apparel',
    price:54.99, compareAt:null, isNew:true, isLimited:false, revPoints:55,
    description:'Midweight fleece crewneck. Relaxed fit. Embroidered VictoryRevConnect-1 logo left chest.',
    sizes:['S','M','L','XL','2XL'],
  ...
  {
    id:'11', name:'VictoryRevConnect-1 Coffee Mug 15oz', category:'Drinkware',
    price:22.99, compareAt:null, isNew:false, isLimited:false, revPoints:23,
    description:'Ceramic mug with wrap-around VictoryRevConnect-1 design. Dishwasher safe. Perfect for early morning wrenching.',
    sizes:['15oz'],
    colors:['Black','White'],
  ...
  {
    id:'12', name:'VictoryRevConnect-1 Racing Jacket', category:'Outerwear',
    price:94.99, compareAt:119.99, isNew:false, isLimited:true, revPoints:150,
    description:'Lightweight bomber-style racing jacket. Embroidered VictoryRevConnect-1 patches, mesh lining. Show-ready.',
    sizes:['S','M','L','XL','2XL'],
    ...
    <div style={{ maxWidth:'1300px', margin:'0 auto' }}>
            ...
            <div style={{ position:'relative', background:'#0D1E30' }}>
              ...
              <div style={{ position:'absolute', bottom:0, left:0, right:0, background:'linear-gradient(transparent, rgba(13,30,48,0.9))', padding:'1.5rem 1rem 1rem' }}>
                <div style={{ display:'inline-flex', alignItems:'center', gap:'0.375rem', background:'rgba(204,0,0,0.85)', borderRadius:'0.375rem', padding:'0.25rem 0.625rem' }}>
                  <span style={{ color:'white', fontWeight:900, fontSize:'0.75rem', letterSpacing:'0.5px' }}>VictoryRevConnect-1</span>
                </div>
              </div>
      ...
      <div style={{ background:'linear-gradient(135deg, rgba(204,0,0,0.1), rgba(21,57,204,0.06))', border:'1px solid rgba(204,0,0,0.15)', borderRadius:'1rem', padding:'1.5rem', marginBottom:'1.5rem', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'1rem' }}>
        <div>
          ...
          <p style={{ color:'rgba(255,255,255,0.4)', marginTop:'0.25rem' }}>Rep VictoryRevConnect-1 · Earn {Math.round(tierData.mult*100)}% Rev Points on every purchase</p>
        </div>
            ...
            <div key={p.id} style={{ background:'#243547', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'1rem', overflow:'hidden', cursor:'pointer', transition:'transform 0.2s, box-shadow 0.2s' }}
              ...
              <div style={{ height:'220px', position:'relative', overflow:'hidden', background:'#0D1E30' }}>
                ...
                <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', background:'rgba(0,0,0,0.6)', borderRadius:'4px', padding:'0.3rem 0.75rem', border:'1px solid rgba(255,255,255,0.3)', pointerEvents:'none' }}>
                  <span style={{ color:'white', fontWeight:700, fontSize:'0.85rem', whiteSpace:'nowrap' }}>VictoryRevConnect-1</span>
                </div>
                {/* Brand watermark */}
                <div style={{ position:'absolute', bottom:'0.75rem', left:'0.75rem', background:'rgba(204,0,0,0.88)', borderRadius:'0.375rem', padding:'0.2rem 0.5rem', backdropFilter:'blur(4px)' }}>
                  <span style={{ color:'white', fontWeight:900, fontSize:'0.65rem', letterSpacing:'0.5px' }}>VictoryRevConnect-1</span>
                </div>
                {/* Badges */}
                {p.badge && (
      ...
      <div style={{ textAlign:'center', marginTop:'2.5rem', padding:'1.5rem', border:'1px solid rgba(255,255,255,0.06)', borderRadius:'0.875rem' }}>
        <p style={{ color:'rgba(255,255,255,0.3)', fontSize:'0.8rem' }}>
          🎽 All items feature the official VictoryRevConnect-1 logo · Free shipping on orders over $75 · Legend members always ship free
        </p>
      </div>
    </div>
  )
