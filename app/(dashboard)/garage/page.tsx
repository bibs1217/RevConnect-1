    ...
    <div style={{ maxWidth:'1100px', margin:'0 auto' }}>
      ...
      <div style={{ background:'linear-gradient(135deg, #1a1a2e, #0D0D0D)', border:'1px solid #2a2a3e', borderRadius:'1rem', padding:'2rem', marginBottom:'2rem', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ display:'flex', alignItems:'flex-end', gap:'1.5rem', flexWrap:'wrap' }}>
          ...
          {user && (
            <button onClick={() => setShowAdd(!showAdd)} style={{ background:'#E63946', color:'white', border:'none', padding:'0.75rem 1.5rem', borderRadius:'0.75rem', fontWeight:700, fontSize:'0.9rem' }}>
              + Add Vehicle
            </button>
          )}
        </div>
      ...
      {user && !loading && vehicles.length === 0 && (
        <div style={{ textAlign:'center', padding:'4rem 2rem', background:'#1a1a2e', border:'1px dashed #2a2a3e', borderRadius:'1rem' }}>
          ...
          <button onClick={() => setShowAdd(true)} style={{ background:'#E63946', color:'white', border:'none', padding:'0.75rem 1.5rem', borderRadius:'0.75rem', fontWeight:700 }}>Add Your First Vehicle</button>
        </div>
      )}
