      ...
      <div style={{ width:'100%', maxWidth:'420px' }}>
        ...
        <div style={{ background:'#071428', border:'1px solid #1A3A6B', borderRadius:'1rem', padding:'2rem' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'1rem', marginBottom:'1.5rem' }}>
            <div style={{ flex:1, height:'1px', background:'#1A3A6B' }} />
          ...
          <form onSubmit={handleLogin} style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
            ...
            <div>
              <div style={{ display:'flex', justifyContent:'space-between', marginBottom:'0.5rem' }}>
                ...
                <Link href="/forgot-password" style={{ fontSize:'0.75rem', color:'#FF4500' }}>Forgot?</Link>
              </div>
        ...
        <p style={{ textAlign:'center', color:'#666', marginTop:'1.5rem', fontSize:'0.875rem' }}>
          No account? <Link href="/register" style={{ color:'#FF4500', fontWeight:600 }}>Join RevConnect-1</Link>
        </p>
      </div>
    </div>
  )
