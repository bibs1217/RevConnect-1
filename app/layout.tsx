      ...
      <head>
        <style>{`
          *{box-sizing:border-box;margin:0;padding:0}
          ...
          @keyframes stripe-move{0%{background-position:0 0}100%{background-position:60px 0}}

          .chrome-text{
            background:linear-gradient(90deg,#A0A0A0 0%,#FFFFFF 25%,#D0D0D0 45%,#FFFFFF 60%,#A0A0A0 80%,#FFFFFF 100%);
            background-size:200% auto;
            -webkit-background-clip:text;
            -webkit-text-fill-color:transparent;
            background-clip:text;
            animation:chrome-shimmer 2.5s linear infinite;
          }
          .card-hover{transition:transform 0.2s,box-shadow 0.2s}
          .card-hover:hover{transform:translateY(-4px)}
          .racing-stripes{
            background:repeating-linear-gradient(45deg,transparent,transparent 10px,rgba(204,0,0,0.04) 10px,rgba(204,0,0,0.04) 20px);
          }
          .chrome-pill{
